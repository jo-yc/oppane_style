<template>
    <div class="container featured footwear mt-4 pb-2">
        <div class="heading heading-flex mb-3">
            <div class="heading-left">
                <h2 class="title">Featured Footwear</h2>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="tab-content tab-content-carousel">
                    <div class="tab-pane fade show active" id="footwear-women">
                    ...
                    <div class="tab-pane fade" id="footwear-men">
...
export default {
    ...
    computed: {
        menProducts: function() {
            return catFilter(this.products, ['men']).slice(0, 3);
        },
        womenProducts: function() {
            return catFilter(this.products, ['women']).slice(3, 6);
        }
    }
};
</script>
